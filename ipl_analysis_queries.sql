...
SELECT * FROM matches WHERE winner=NULL;
...
UPDATE matches SET venue= 'Rajiv Gandhi International Stadium, Uppal' WHERE venue='Rajiv Gandhi International Stadium';
...
select toss_winner ,COUNT(*) AS won FROM matches WHERE toss_winner=winner GROUP BY toss_winner ORDER BY won DESC;
